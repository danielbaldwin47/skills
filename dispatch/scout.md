...
4. **Judge unattended fit** per [unattended-fit.md](unattended-fit.md) — read it. Unfit tickets leave the batch and go to the `awake:` list with their disqualifying precondition.
